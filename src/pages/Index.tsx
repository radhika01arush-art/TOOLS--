...
import { Sparkles, User, LogOut, LogIn, Calculator, Percent, TrendingUp } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card 
              className="glass-card hover:shadow-xl transition-all duration-300 cursor-pointer group border-2 hover:border-primary/50"
              onClick={() => navigate("/profit-loss-calculator")}
            >
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-3 rounded-xl bg-primary/10 group-hover:bg-primary/20 transition-colors">
                  ...
                  <CardTitle className="text-2xl font-bold">Profit & Loss Calculator</CardTitle>
                </div>
                <CardDescription className="text-base">
                  Calculate profit, loss, margins, markup, and pricing for your business
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
