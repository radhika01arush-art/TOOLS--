            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-muted/50 rounded-lg text-center">
                  ...
                  <p className="text-3xl font-bold text-primary">{formatNumber(percentOfResult)}</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-muted/50 rounded-lg text-center">
                  ...
                  <p className={`text-3xl font-bold ${changeResult !== null ? (changeResult >= 0 ? 'text-green-500' : 'text-red-500') : 'text-primary'}`}>
          ...
          <TabsContent value="adjust" className="mt-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-muted/50 rounded-lg text-center">
                  <p className="text-sm text-muted-foreground mb-1">Result</p>
                  <p className="text-3xl font-bold text-primary">{formatNumber(adjustByResult)}</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
